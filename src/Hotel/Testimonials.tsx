...
function Testimonial({testimonial,user,location}:TestimonialProps){
    ...
    return(
        <motion.div whileInView={{opacity:1,y:0}} initial={{scale:1,opacity:0,y:40}} viewport={{once:true}} transition={{duration:0.6, ease:easeIn}} whileHover={{scale:1.02, boxShadow:'1px 4px 7px grey', cursor:'pointer'}} exit={{scale:1, boxShadow:"0px 0px 0px black"}} className="flex flex-col gap-8 font-inter rounded-[10px] bg-surface p-7">
