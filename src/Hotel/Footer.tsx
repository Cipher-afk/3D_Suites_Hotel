        ...
        <div className="flex flex-row p-2.5 lg:p-0 gap-4 lg:gap-0
         justify-between mt-7">
            <div className="lg:self-center self-start">
                <p className="font-cinzel font-bold text-gold text-4xl">3D Suites N Lounge</p>
                <p className="text-subText font-medium font-inter">Redefining luxury and hospitality with elegance, <br /> comfort, and unmatched service.</p>
            </div>  
