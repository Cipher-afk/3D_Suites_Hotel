...
function Experiences({icon:Icon,title}:ExperiencesProps){
    return(
        <motion.div whileInView={{opacity:1,scale:1}} initial={{opacity:0,scale:0.8}} transition={{duration:0.6, ease:easeIn}} viewport={{once:true}} className="flex flex-col p-4 items-center bg-surface font-inter font-medium rounded-[10px] gap-1">
